...
- The defining trend for Twenty this week: AI agents are becoming a built-in CRM primitive across open-source GTM tools (Auxx.ai, Budibase, DenchClaw), and the Model Context Protocol (MCP) is emerging as the integration substrate agents use to read/write apps.
...
**Why now:** [PgCortex: AI enrichment per Postgres row, zero txn blocking](https://github.com/supreeth-ravi/pgcortex), [Show HN: Clay-like enrichment in Google Sheets](https://www.getvurge.com/)
...
**Why now:** [Gradient Labs: an AI account manager per bank customer](https://openai.com/index/gradient-labs), [Parloa: service agents customers want to talk to](https://openai.com/index/parloa)
...
**Why now:** [HN: 'Salesforce, SAP, or ServiceNow — which is ripe for disruption?'](https://news.ycombinator.com/item?id=46601662), [Ask HN: how to sell SaaS without AI features in 2026?](https://news.ycombinator.com/item?id=47023609)
...
**Why now:** [Parloa: service agents customers want to talk to](https://openai.com/index/parloa), [Budibase Agents: model-agnostic agents for internal workflows](https://budibase.com/blog/updates/ai-agents-beta/), [Netomi: scaling agentic systems into the enterprise](https://openai.com/index/netomi)
...
The OSS CRM/GTM category is racing to make AI agents a built-in primitive, not an add-on — exactly Twenty's stated posture, now contested by newer entrants like Auxx.ai, Budibase Agents, and DenchClaw.

Sources: [DenchClaw — local CRM on an agent runtime](https://github.com/DenchHQ/DenchClaw), [Auxx.ai — support CRM = 'Attio + n8n'](https://auxx.ai), [Budibase Agents (Beta)](https://budibase.com/blog/updates/ai-agents-beta/)
...
Sources: [Airweave — let agents search any app](https://github.com/airweave-ai/airweave), [PolyMCP — MCP tools + orchestration](https://news.ycombinator.com/item?id=47061490), [Hugging Face MCP Server](https://huggingface.co/blog/building-hf-mcp)
...
Sources: [PgCortex — AI enrichment per Postgres row](https://github.com/supreeth-ravi/pgcortex), [Clay-like enrichment in Google Sheets (Show HN)](https://www.getvurge.com/), [AgentWeb — business directory API for agents](https://agentweb.live)
...
Sources: [Netomi — scaling agentic systems in the enterprise](https://openai.com/index/netomi), [Gradient Labs — an AI account manager per customer](https://openai.com/index/gradient-labs), [Parloa — service agents customers want to talk to](https://openai.com/index/parloa)
...
Sources: [HN — Salesforce/SAP/ServiceNow: ripe for disruption?](https://news.ycombinator.com/item?id=46601662), [Ask HN — how to sell SaaS without AI features in 2026?](https://news.ycombinator.com/item?id=47023609), [ServiceNow powers actionable enterprise AI with OpenAI](https://openai.com/index/servicenow-powers-actionable-enterprise-ai-with-openai)

## Provenance

Scanned **2935** items from **5** sources, **827** relevant.
